...
Pdp.prototype.canReadEntityPolicies = function (userInfo, entityInfo) {
  ...
  return new Promise(function (resolve, reject) {
    upfront.init(that.conf.upfront).then(function () {
      return that.canReadEntityAttribute(userInfo, entityInfo, that.conf.policies['action-policy-root'].attribute+".policy");
    }).then(function (res) {
      resolve(res);
    }).catch(reject);
  });
...
Pdp.prototype.canSetEntityPolicy = function (userInfo, entityInfo) {
  ...
  return new Promise(function (resolve, reject) {
    upfront.init(that.conf.upfront).then(function () {
      return that.canWriteToAttribute(userInfo, entityInfo, that.conf.policies['action-policy-root'].attribute+".policy");
    }).then(function (res) {
      resolve(res);
    }).catch(reject);
  });
...
Pdp.prototype.canWriteToPolicy = function (userInfo, entityInfo, policyName, policy) {
  return this.canSetEntityPolicy(userInfo, entityInfo);
};
