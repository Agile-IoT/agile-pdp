module.exports.buildConfig = function (config) {
  console.log(`actions: ${config.upfront_locks }`)
  config.upfront = {
    ulocks: {
      entityTypes: {
        "/any": 0,
      ...
      locks: config.upfront_locks ||__dirname + "/../node_modules/agile-upfront-locks/Locks",
      actions: config.upfront_actions ||__dirname + "/../node_modules/agile-upfront-locks/Actions"
